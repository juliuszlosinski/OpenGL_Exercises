...
TASK: Now create the same 2 triangles using two different VAOs and VBOs for their data.
...
int main(void)
{
	...
	GLuint firstShaderProgram = getLinkedProgram_PATHS_TO_FILES("Shaders/firstVertexShader.vert", "Shaders/firstFragShader.frag");
	...
	GLuint secondShaderProgram = getLinkedProgram_PATHS_TO_FILES("Shaders/secondVertexShader.vert", "Shaders/secondFragShader.frag");
